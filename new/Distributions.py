...
from probjax.distributions import Distribution, Independent
from probjax.utils.linalg import transition_matrix, matrix_fraction_decomposition
...
class Independent2(Distribution):
    ...
    def rsample(self, key, sample_shape=()):
        keys = jax.random.split(key, len(self.base_dist))
        samples = jnp.stack(
